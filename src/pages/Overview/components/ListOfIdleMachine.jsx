...
export default function ListOfIdleMachine() {
  ...
  return (
    <div className="bg-white shadow-[5px_5px_20px_1px_rgba(0,0,0,0.2)] p-8 rounded-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 bg-primary rounded-md md:rounded-full p-4 text-white mt-6">
        <p>Machine Names</p>
        <p>Idle Time</p>
      ...
      {formingMachine
        ...
        ?.map((machine) => (
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6 border md:border-none rounded-md md:rounded-full p-2 text-black mt-6">
